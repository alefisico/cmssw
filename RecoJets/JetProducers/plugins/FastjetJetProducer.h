...
protected:
 ...
 private:
  ...
  bool useRecursiveSoftDrop_; /// Recursive Soft drop
  ...
  double beta_;               /// for soft drop OR recursive SD : beta (angular exponent)
  double R0_;                 /// for soft drop OR recursive SD : R0 (angular distance normalization - should be set to jet radius in most cases)
  int    nRSD_;               /// for recursive soft drop : the requested number of iterations
