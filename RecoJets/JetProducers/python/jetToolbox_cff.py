...
def jetToolbox( proc, jetType, jetSequence, outputFile, addSubstructure=True, addGroomers=True, addNsub=True, addNsubUpTo5=False, addQJets=True, addSubjets=False, minPt=100. ):
