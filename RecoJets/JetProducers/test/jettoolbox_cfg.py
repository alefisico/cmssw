...
process.out.outputCommands += ['keep *_NjettinessCA8_*_*',
                               ...
                               'keep *_ca8PFJetsCHSMassDropFilteredLinks_*_*','keep *_cmsTopTagPFJetsCHSLinksCA8_*_*']
...
process.out.outputCommands += ['keep *_NjettinessCA15_*_*',
                               'keep *_QJetsAdderCA15_*_*',
                               'keep *_ca15PFJetsCHSPrunedLinks_*_*','keep *_ca15PFJetsCHSTrimmedLinks_*_*','keep *_ca15PFJetsCHSFilteredLinks_*_*',
			       'keep *_ca15PFJetsCHSMassDropFilteredLinks_*_*', 'keep *_hepTopTagPFJetsCHSLinksCA15_*_*']
...
process.patJetsCA8PFCHS.userData.userFloats.src += ['NjettinessCA8:tau1','NjettinessCA8:tau2','NjettinessCA8:tau3','NjettinessCA8:tau4','NjettinessCA8:tau5',
                                                    ...
                                                    'ca8PFJetsCHSMassDropFilteredLinks','cmsTopTagPFJetsCHSLinksCA8']
...
process.patJetsCA15PFCHS.userData.userFloats.src += ['NjettinessCA15:tau1','NjettinessCA15:tau2','NjettinessCA15:tau3','NjettinessCA15:tau4','NjettinessCA15:tau5',
                                                    'QJetsAdderCA15:QjetsVolatility',
                                                    'ca15PFJetsCHSPrunedLinks','ca15PFJetsCHSTrimmedLinks','ca15PFJetsCHSFilteredLinks',
						    'ca15PFJetsCHSMassDropFilteredLinks', 'hepTopTagPFJetsCHSLinksCA15' ]
